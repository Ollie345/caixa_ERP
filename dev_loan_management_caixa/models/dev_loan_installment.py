...
class dev_loan_installment(models.Model):
    ...
    def send_by_mail(self):
        self.ensure_one()
        template_id = self.env.ref('dev_loan_management_caixa.template_overdue_installment_send_by_mail')
        ctx = {
    ...
    def loan_installment_reminder(self):
        ...
        template_id = ir_model_data._xmlid_lookup('dev_loan_management_caixa.installment_reminder_email_template')[1]
